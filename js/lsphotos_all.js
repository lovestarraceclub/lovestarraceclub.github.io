    ...
    $.getJSON(jsonData)
        .done(function(data) {
            ...
            $.each(data.images, function(i, item) {
                ...
                $('<div class="col-sm-6 col-md-3 col-lg-3"><div class="instagram-item"><div class="hover-bg"><a href="' + item.media_file_path + '" title="' + item.caption + '" rel="lightbox"><div class="hover-text"><h4>' + item.owner.username + '</h4><small>' + item.caption + '</small> </div><img data-original="' + item.thumbnail_path + '" class="img-responsive lazy" alt="' + item.caption + '"> </a></div></div></div>').appendTo('.instagram-items');
